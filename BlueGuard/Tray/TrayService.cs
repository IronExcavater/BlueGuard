...
internal sealed partial class TrayService : IDisposable
{
    ...
    public TrayService()
    {
        ...
        Protection.Toggled += (_, enabled) => { UpdateTrayIcon(enabled); if (ReopenAfterToggle.IsEnabled) ReopenMenu(); };
        Startup.Toggled += (_, _) => { if (ReopenAfterToggle.IsEnabled) ReopenMenu(); };
        ...
        var flyout = new MenuFlyout
        {
            ...
            Items = { Protection.Item, Startup.Item, ReopenAfterToggle.Item, separator, exit },
        };
